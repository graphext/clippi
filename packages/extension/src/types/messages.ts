...
export type SidePanelToBackgroundMessage =
  ...
  | { type: 'UPDATE_TARGET'; payload: { id: string; updates: Partial<RecordedTarget> } }
  | { type: 'DELETE_TARGET'; payload: { id: string } }
  | { type: 'UPDATE_STEP'; payload: { targetId: string; stepId: string; updates: Partial<RecordedStep> } }
